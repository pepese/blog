...
プログラミング未経験者・初心者の方で、プログラミングスキルを上げたいけど何をしていいか分からない、どうすれば上達するのか？と考えている人向けの記事です。
...
さらに言うと、 <span style="font-weight: bold;background:linear-gradient(transparent 70%, #FFFF00 0%);">IT エンジニアは IT 企業からのみ求められる人材では無い</span> です。  
